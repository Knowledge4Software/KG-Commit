...
"""
import argparse, json, subprocess, sys, tempfile, os, threading, queue
...
# ── git helpers (identical semantics to the AST engine) ──────────────────────
...
def ckpt_path(kind):
    return PROJECT_ROOT / "outputs" / f"online_kg_checkpoint_{kind}.json"
