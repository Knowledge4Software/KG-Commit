...
# online-trajectory VISUALISATION resolution (chosen from stride/window
# comparison): affects only the stream figures, not the protocol/metrics.
TRAJ_STRIDE = 25; TRAJ_WINDOW = 150
...
def metric_traj(y_ev, p_ev, warmup, roll=TRAJ_WINDOW, step=TRAJ_STRIDE):
