...
\begin{document}
	...
	\begin{itemize}[nosep,leftmargin=1.4em]
		...
		\item \textbf{V2c --- PDG/CPG:} \emph{program-dependence graph} (control +
	...
	plus a small new \code{SeqBuilder}. A thin wrapper (\code{subgraph\_builders.py})
	...
	PDG/CPG & 63 & 0.595 & 0.820 & 0.585 & 0.396 & 0.464 & 0.378 \\
	...
	\input{figures/v4/tab_fusion_bysize.tex}
	...
	overturns this ordering. Finally, a comprehensive fusion ablation over all
	combinations of ten inference methods selects a compact, \textbf{purely
	graph-native final Fusion $=R+T+G$} (relational priors, AST structural change,
	and CSTG semantics) that improves on the previous metrics-inclusive fusion while
	discarding the non-graph JIT metrics. This justifies the
	...
	evaluation (\code{inference/run\_subgraph\_rq.py}), the tables/figures
	(\code{inference/make\_subgraph\_tables.py}, \code{make\_subgraph\_figures.py})
	and the results notebook
